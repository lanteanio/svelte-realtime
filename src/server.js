 ...
 */
const _smoothClosedWs = new WeakSet();
 ...
 * @param {any} ws
 */
function _drainSmoothOnClose(ws) {
 ...
 */
live.smooth = function smooth(config) {
	if (!config || typeof config !== 'object') {
 ...
 */
const _crdtClosedWs = new WeakSet();
 ...
 */
const _crdtDeclRegistrations = new Map();
...
function _crdtRegister(kind, config) {
