...
// client) where every microsecond on the hot path adds up. A single-digit-percent
// regression on a hot primitive is a merge blocker; this is the opposite -- a
// measurable improvement on the same hot primitive.
