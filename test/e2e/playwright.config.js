...
const projects = [];
const specs = ['queue-replay.spec.js', 'lock.spec.js', 'smoke.spec.js', 'multi-page.spec.js', 'reconnect.spec.js', 'multi-page-auth.spec.js', 'schema-validation.spec.js', 'presence.spec.js', 'cursor.spec.js', 'channels.spec.js', 'room.spec.js', 'derived.spec.js', 'cron.spec.js', 'uploads.spec.js'];
